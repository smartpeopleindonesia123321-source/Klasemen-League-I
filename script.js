...
const animalDatabase = {
    ...
    "Aldi": { sp: "Aldi The Megalodon Shark", atk: 94, def: 80, spd: 90, desc: 'Predator samudra yang dingin dan mematikan : Mengintai dari kegelapan lautan dalam, Aldi adalah perwujudan dari ancaman tanpa suara. Dengan indra penciuman tajam dan gigitan berdaya hancur tinggi, ia meluncur cepat untuk menerkam musuh sebelum mereka menyadari bahaya.' },
    "Regi": { sp: "Regi The Black Panther", atk: 90, def: 78, spd: 96, desc: 'Bayangan malam yang mematikan : Regi berburu dalam diam dengan kelincahan dan refleks luar biasa. Memanfaatkan menyamarnya bulu hitam pekat, ia mampu mendekati target tanpa terdeteksi sebelum mendaratkan serangan kejutan yang fatal.' },
    "Rizal": { sp: "Rizal The Siberian Tiger", atk: 96, def: 84, spd: 91, desc: 'Raja rimba salju yang dominan : Rizal adalah predator puncak dengan dominasi mutlak di medan tempur. Menggabungkan ukuran tubuh yang kuat dengan kekuatan cakar mematikan, setiap langkahnya memancarkan aura ancaman yang mengintimidasi barisan lawan.' },
    ...
    "Ikmal": { sp: "Ikmal The Golden Eagle", atk: 82, def: 65, spd: 99, desc: 'Penguasa langit berkecepatan tinggi : Ikmal memantau seluruh area tempur dari ketinggian dengan penglihatan tajam. Begitu celah terbuka, ia melakukan manuver menukik tajam berkecepatan kilat untuk mencengkeram targetnya.' },
    "Muiz": { sp: "Muiz The Mustang Stallion", atk: 78, def: 70, spd: 98, desc: 'Stamina tanpa batas dan kecepatan tinggi : Muiz adalah perwujudan kebebasan dan daya tahan di padang terbuka. Mengandalkan otot kaki yang luar biasa kuat, ia mampu memacu kecepatan penuh secara konsisten dari awal hingga akhir laga.' },
    "Abdul": { sp: "Abdul The Arctic Wolf", atk: 88, def: 82, spd: 92, desc: 'Pemburu dingin bertaktik tajam : Di balik tatapan matanya yang tajam dan tenang, Abdul adalah serigala salju dengan insting memburu yang presisi. Ia mampu mengepung target dengan ketenangan penuh sebelum melancarkan serangan kejutan.' },
    "Dicky": { sp: "Dicky The Red Dragon", atk: 99, def: 99, spd: 75, desc: 'Raksasa mistis penguasa medan tempur : Berdiri di puncak tertinggi hierarki kekuatan, Dicky adalah perwujudan ancaman absolut. Dengan sisik sekeras baja dan kekuatan destruktif tiada tanding, ia mendominasi area permainan tanpa celah.' }
};
